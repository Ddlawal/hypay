    ...
    return (
        <svg width={size} height={size} viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                stroke-width="2"
            />
            <path d="M11 6.5H11.01" stroke={color} stroke-width="2" stroke-linecap="round" />
            <path d="M9 10.5H11V15.5" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M9 15.5H13" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
    )
}
