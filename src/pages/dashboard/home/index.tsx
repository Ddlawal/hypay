...
import { BagIcon, CameraIcon } from '../../../components/Icons'
            ...
            {addProduct ? (
                <div className="pl-5">
                    <p className="text-md mt-5 text-left font-bold text-black md:mt-3">
                        You don't have any products registered in your store yet.
                        <br />
                        Let's start selling?
                    </p>
                    <Button onClick={() => setAddProduct(!addProduct)} className="my-2 px-3 text-white" primary>
                ...
                <div className="ml-20 w-7/12 ">
                    <header className="mx-auto mt-10 w-full">
                        <h1 className="text-left text-[32px] font-bold text-black">Add a product</h1>
                    </header>
                    <form onSubmit={(e) => e.preventDefault()} className="mt-4 w-10/12">
                        ...
                        <div>
                            ...
                            <Button className="rounded-md border-[1px] border-hypay-pink bg-white px-6 text-hypay-pink outline-none">
                                Copy Link
                            </Button>
                            ...
                            <div className="mt-10">
                                ...
                                <div className="my-2">
                                    <div
                                        id="description"
                                        className="mt-1 rounded-md border-[1px] border-hypay-gray px-2 py-1"
                                    >
                                        <input
                                            type="text"
                                            className="w-full border-none bg-transparent outline-none"
                            ...
                            <div className="my-3 flex items-center  justify-between rounded-sm bg-white  p-2 shadow-md">
