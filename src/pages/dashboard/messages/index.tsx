...
export const MessagesCard = ({ messageThread: { messages, thread_id } }: messageCardProps) => {
        ...
        <div>
            <Card className="my-3 hidden items-center justify-between rounded-md p-3 pl-8 text-sm shadow-xl md:flex">
                ...
                <div className="flex w-[20%] items-center justify-between">
                    <NextLink href={`/dashboard/messages/${thread_id}`}>
...
function Messages() {
    ...
    return (
        <PrimaryLayout isLoading={isLoading}>
                ...
                <div className="md:w-10/12">
                    ...
                    <main className="">
                        {messageThreads.map((messageThread) => (
                            <MessagesCard key={messageThread.thread_id} messageThread={messageThread} />
                        ))}
                    </main>
                </div>
            </div>
