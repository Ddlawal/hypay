        ...
        <BuyerLayout>
            <div className="my-12 px-[33%]">
                ...
                <Card>
                    ...
                    <div className="my-4 flex gap-x-5 rounded bg-[#F2F2F2] py-4 px-2">
                        ...
                        <div>
                            ...
                            <div className="text-xs">
                                Jaqueta jeans azul claro com camurça feita de lã de carneiro. Possui bolsos e botões na
                                parte da frente.
                            </div>
                        </div>
                    </div>
                    ...
                    <Button className="mt-10 block w-full bg-black text-lg font-bold text-white" padding="py-4">
                        Continue
                    </Button>
