    ...
    return (
        <>
            ...
            <main className="relative flex h-screen flex-col bg-login-books bg-cover bg-center">
                ...
                <div className="absolute top-[0%] w-[100vw] bg-white py-2 px-4 md:right-[50%] md:left-[50%] md:top-[15%] md:-mr-[50%] md:-ml-[10rem] md:h-[30rem] md:w-[22rem] md:rounded-md md:shadow-md">
